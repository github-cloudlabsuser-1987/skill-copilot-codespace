...
def calculator():
    ...
    Note:
    - If an invalid choice is entered, the function will display an "Invalid input" message.
    - Division by zero should be handled in the `divide` function to avoid runtime errors.
    """
